...
<html>
	...
	<body>
		...
		<div class="i_content">
			<div class="adr_wrap">
				<div class="adr">
					<span class="adr_link"><a href="index.jsp">首   页</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;酒品介绍</span>
				</div>
			</div>
			<div class="c_area">
				<div class="left_list">
					<div class="nav_title">酒品介绍</div>
					<div class="sidemenu">
						<ul>
				...
				<div class="right_content">
					<div class="con_title">酒品介绍</div>
					<div class="con_box">
						<ul class="items-list">
						       <%List nnliet=news.get1ComList("select * from news where fenlei='酒品介绍'");
		                    	if(!nnliet.isEmpty()){
