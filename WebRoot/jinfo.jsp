...
<html>
	<head>
		...
		<SCRIPT type=text/javascript>
                    ...
                    List hotlist=abc.getOneAffiche(Integer.parseInt(id));
                    if(!hotlist.isEmpty()){
         			%>
	</head>
	<body>
		...
		<div class="i_content">
			<div class="adr_wrap">
				<div class="adr">
					<span class="adr_link"><a href="index.jsp">首   页</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;新闻公告</span>
				</div>
			</div>
			<div class="c_area">
				<div class="left_list">
					<div class="nav_title">新闻公告</div>			
					<div class="contact">
				...
				<div class="right_content">
					...
					<h1 align="center"><%=hotlist.get(1).toString() %></h1><br>
					 <h4 align="center">发布人：<%=hotlist.get(4).toString() %>  发布时间：<%=hotlist.get(3).toString() %></h4> <br>
						<%=hotlist.get(2).toString() %>
					</div>
					<%}%>
				</div>
				<div class="clear"></div>
