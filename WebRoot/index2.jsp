        ...
        <TR>
          <TD class=middle align=left>
			...
			<TR>
				...
				<li>
				<a href="nDetail.html">
				<%=affList2.get(1).toString() %>
				</a>
				<span class="date">
				<%=affList2.get(2).toString() %>
				</span>
				</li>
				</TD>
			  </TR>
...
<TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  ...
  <TR>
    <TD>
      <img src="images/aaa.jpg" width="474" height="100" border="0"><img src="images/bbb.jpg" width="474" height="100" border="0">
	</TD>
   </TR>
  </TBODY>
</TABLE>
