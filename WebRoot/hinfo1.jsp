...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
		  ...
		  <TD align=left><br>
		  酒吧名称：<%=hotlist.get(1).toString()%> <br>
		  ...
		  <a href="<%=basePath%>prepinfo.jsp?id=<%=id%>&title=<%=hotlist.get(1).toString()%>">我要预订该酒吧房间</a> （如果您还没有登录，请先登录再进行预定操作！）
		  </TD>
		</TR>
		<TR>
