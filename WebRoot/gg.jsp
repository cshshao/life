		...
		<div class="i_content">
			...
			<div class="c_area">
				<div class="left_list">
					...
					<div class="sidemenu">
						<ul>
							<li><a href="lxs.jsp">bar台</a></li>
							<li><a href="jd.jsp">酒品介绍</a></li>
						</ul>
					</div>
					<div class="contact">
				...
				%>
						...
						<%-- 	<li><a href="<%=basePath%>newsinfo.jsp?id=<%=allnew.get(0).toString()%>"><%=allnew.get(1).toString()%></a><span class="date"><%=allnew.get(3).toString()%></span></li> --%>
