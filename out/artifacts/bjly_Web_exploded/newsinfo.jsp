...
%>
	...
	<body>
		...
		<div class="i_content">
			<div class="adr_wrap">
				<div class="adr">
					<span class="adr_link"><a href="index.jsp">首   页</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;<%=list.get(2).toString() %></span>
				</div>
			</div>
			<div class="c_area">
				<div class="left_list">
					<div class="nav_title"><%=list.get(2).toString() %></div>			
					<div class="contact">
						<a href="contact.jsp"><img src="images/tel.jpg" /></a>
					</div>
				</div>
				<div class="right_content">
					<div class="con_title"><%=list.get(2).toString() %></div>
					<div class="con_box">
					<h1 align="center"><%=list.get(1).toString() %></h1>
						 <p>
						  <h4 align="center">发布人：<%=list.get(5).toString() %>  发布时间：<%=list.get(4).toString() %>  点击率：<%=list.get(6).toString() %>
						 </h4>
						 </p>
						 <p> <%=list.get(3).toString() %></p>
					</div>
				</div>
				<div class="clear"></div>
			</div>
