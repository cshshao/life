...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR><input type=hidden name=sid value=<%=request.getParameter("id")%>><input type=hidden name=title value=<%=title%>>
          <TD width=45% align=right>酒吧名称：</TD><TD align=left><%=title %></TD> 
		</TR> 
		<TR>
          <TD width=45% align=right>bar台人数：</TD><TD align=left><input type=text name=rs ></TD>
		</TR>
		<TR>
          <TD  align=right>bar台时间：</TD><TD align=left><input type=text name=sj  ></TD>
		</TR>
		<TR>
          <TD  align=right>预定时间：</TD><TD align=left><input type=text name=ts  ></TD>
		</TR>
		<TR>
